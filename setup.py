...
# Package meta-data.
NAME = "woffle"
DESCRIPTION = "An open-source GUI application to create woff and woff2 web fonts"
LICENSE = "GNU General Public License v3 (GPLv3)"
URL = "https://github.com/source-foundry/Woffle"
...
setup(
    ...
    entry_points={"console_scripts": ["woffle = woffle.__main__:main"]},
    classifiers=[
